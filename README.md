...
FAQ Chatbot using Python (CodeAlpha AI Internship Task)

📝 Purpose of This Project

This project is developed as part of the CodeAlpha AI Internship to demonstrate:
...
Many users repeatedly ask the same questions. This FAQ Chatbot:
...
├── faqs.py          → Contains FAQ questions, answers, and matching logic
